...
$mimin = query("SELECT * FROM admin WHERE id_admin = $idadmin")[0];
...
<body id="page-top">
    ...
    <div class="card-header py-3" style="background: #4e73df;" style="margin-top: 5px;">
        <h6 style="color: white;">Ubah data admin</h6>
    </div>
    
               <div class="card-body">
               <input type="hidden" name="id_admin" value="<?= $mimin["id_admin"]; ?>">
               <input type="hidden" name="gambarLama" value="<?= $mimin["foto"]; ?>">
                   <div class="form-group row">
                   <div class="table-responsive"></div>
					<label for="level" class="col-sm-3 col-form-label">Level</label>
					<div class="col-sm-7">
						<select class="form-control" id="level" name="level" value="<?= $mimin["level"] ?>">
                ...
                <div class="form-group row">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" name="username" id="username" value="<?= $mimin["username"] ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="nama" class="col-sm-3 col-form-label">Nama</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="nama" id="nama" value="<?= $mimin["nama"] ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="email" class="col-sm-3 col-form-label">Email</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="email" id="email" value="<?= $mimin["email"] ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="password" class="col-sm-3 col-form-label">Password</label>
					<div class="col-sm-7">
						<input type="password" class="form-control" name="password" id="password" value="<?= $mimin["password"] ?>">
					</div>
				</div>
				<div class="form-group row">
                    <label for="foto" class="col-sm-3 col-form-label">Foto </label>
                    <div class="col-sm-7">
                    <img src="img/upload/<?= $mimin['foto']; ?>" style="width: 150px;">
                    <br>
