...
<body id="page-top">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="background: blue;">
                    ...
                    <form
                        ...
                        <a href="admin.php" class="logo me-auto"><strong> Halaman data Pegawai!</strong></a>
                        </div>
                    </form>
    ...
    <div class="card-header py-3" style="background: #4e73df;" style="margin-top: 5px;">
        <h6 style="color: white;">Tambah data pegawai</h6>
    </div>
               ...
               <div class="card-body">
                   ...
                   <div class="table-responsive"></div>
					...
					<div class="col-sm-7">
						<select class="form-control" id="level" name="jenis_kelamin">
