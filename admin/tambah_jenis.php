...
<body id="page-top">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="background: blue;">
                    ...
                    <form
                        ...
                        <a href="admin.php" class="logo me-auto"><strong> Halaman data Jenis Obat!</strong></a>
                        </div>
                    </form>
        ...
        <div class="row mb-2" style="margin: 10px;">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="dataobat.php">Data Jenis Obat</a></li>
    ...
    <div class="card-header py-3" style="background: #4e73df;" style="margin-top: 5px;">
        <h6 style="color: white;">Tambah data Jenis Obat</h6>
    </div>
               ...
               <div class="card-body">
				<div class="form-group row">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" name="nama_jenisobat" id="nama_jenisobat" value="">
					</div>
				</div>
				<div class="form-group row">
