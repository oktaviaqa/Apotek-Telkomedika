            ...
            <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <a href="index.php" class="logo me-auto"><strong> Selamat datang Admin Telkomedika!</strong></a>
                        </div>
                    </form>
...
<div class="col-xl-8 col-lg-7">
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ["Obat", "Baby Care", "Alat Kesehatan", "Beauty Care", "Nutrisi", "Home Diagnostic"],
                datasets: [{
                    label: '',
                    data: [
                        <?php
                        ...
                        <?php
                            $jumlah_baby    = mysqli_query($conn, "SELECT * from obat WHERE jenis_obat = 'Baby Care'");
                            echo mysqli_num_rows($jumlah_baby); ?>,
                        <?php
                            $jumlah_alat  = mysqli_query($conn, "SELECT * from obat WHERE jenis_obat = 'Alat Kesehatan'");
                            echo mysqli_num_rows($jumlah_alat); ?>,
                        <?php
