...
$jenisobat = query("SELECT * FROM jenis_obat WHERE id_jenis = $idjenis")[0];
...
<body id="page-top">
        ...
        <div class="row mb-2" style="margin: 10px;">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="pegawai.php">Data jenis obat</a></li>
              <li class="breadcrumb-item active">Ubah jenis obat</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <div class="card-header py-3" style="background: #4e73df;" style="margin-top: 5px;">
        <h6 style="color: white;">Ubah jenis obat</h6>
    </div>
    
               <div class="card-body">
               <input type="hidden" name="id_jenis" value="<?= $jenisobat["id_jenis"]; ?>">
               <input type="hidden" name="gambarLama" value="<?= $jenisobat["foto"]; ?>">
				<div class="form-group row">
					<label for="nama" class="col-sm-3 col-form-label">Nama jenis</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="nama_jenisobat" id="nama" value="<?= $jenisobat["nama_jenisobat"] ?>">
					</div>
				</div>
				<div class="form-group row">
                    <label for="foto" class="col-sm-3 col-form-label">Foto </label>
                    <div class="col-sm-7">
                    <img src="img/upload/<?= $jenisobat['foto']; ?>" style="width: 150px;">
                    <br>
