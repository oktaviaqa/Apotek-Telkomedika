...
$obat = query("SELECT * FROM obat WHERE id_obat = $idobat")[0];
...
<body id="page-top">
    ...
    <div class="card-header py-3" style="background: #4e73df;" style="margin-top: 5px;">
        <h6 style="color: white;">Ubah data obat</h6>
    </div>
    
               <div class="card-body">
               <input type="hidden" name="id_obat" value="<?= $obat["id_obat"]; ?>">
               <input type="hidden" name="gambarLama" value="<?= $obat["foto"]; ?>">
               <div class="form-group row">
					<label for="kemasan" class="col-sm-3 col-form-label">Kemasan</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="kemasan" id="kemasan" value="<?= $obat["kemasan"]; ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="jenis_obat" class="col-sm-3 col-form-label">Jenis obat</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="jenis_obat" id="jenis_obat" value="<?= $obat["jenis_obat"]; ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="nama_obat" class="col-sm-3 col-form-label">Nama obat</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="nama_obat" id="nama_obat" value="<?= $obat["nama_obat"]; ?>">
					</div>
				</div>
                <div class="form-group row">
                ...
                <div class="form-group row">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" name="deskripsi" id="deskripsi" value="<?= $obat["deskripsi"]; ?>">
					</div>
				</div>
				<div class="form-group row">
                    <label for="foto" class="col-sm-3 col-form-label">Foto </label>
                    <div class="col-sm-7">
                    <img src="img/upload/<?= $obat['foto']; ?>" style="width: 150px;">
                    <br>
