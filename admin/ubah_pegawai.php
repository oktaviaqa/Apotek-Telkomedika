...
$pegawai = query("SELECT * FROM pegawai WHERE id_pegawai = $idpegawai")[0];
...
<body id="page-top">
    ...
    <div class="card-header py-3" style="background: #4e73df;" style="margin-top: 5px;">
        <h6 style="color: white;">Ubah data pegawai</h6>
    </div>
               ...
               <input type="hidden" name="gambarLama" value="<?= $pegawai["foto"]; ?>">
                   ...
                   <div class="table-responsive"></div>
					...
					<div class="col-sm-7">
						<select class="form-control" id="level" name="jenis_kelamin" value="<?= $pegawai["jenis_kelamin"] ?>">
				...
				<div class="form-group row">
					...
					<div class="col-sm-7">
						<input type="text" class="form-control" name="nama_pegawai" id="nama" value="<?= $pegawai["nama_pegawai"] ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="email" class="col-sm-3 col-form-label">Alamat</label>
					<div class="col-sm-7">
						<input type="text" class="form-control" name="alamat" id="email" value="<?= $pegawai["alamat"] ?>">
					</div>
				</div>
				<div class="form-group row">
                    <label for="foto" class="col-sm-3 col-form-label">Foto </label>
                    <div class="col-sm-7">
                    <img src="img/upload/<?= $pegawai['foto']; ?>" style="width: 150px;">
                    <br>
